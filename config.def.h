 ...
 */
static const char *bgfile = "/home/pearl/wallpapers/backgroundblur.ff";
...
static const ColorScheme schemes[] = {
	...
	{{"#282a2e", "#a54242", "#8c9440", "#de935f",
	  "#61afef", "magenta3", "#5e8d87", "#ffffff",
	  "#373b41", "#cc6666", "#b5bd68", "#f0c674",
	  "#00d7ff", "magenta", "#8abeb7", "#c5c8c6",
	  [256]="#555555", "#ffffff"}, 7, 0, 256, 257},
	// st (dark)
